"""
Django settings for termooo project.
...
SECRET_KEY = config(
    'SECRET_KEY',
    default='django-insecure-s5atp6(dh!=xu%+8)($)ze#ax4e-+hsq4so7wx1kyj$vptz1!x',
)
...
WSGI_APPLICATION = 'termooo.wsgi.application'
